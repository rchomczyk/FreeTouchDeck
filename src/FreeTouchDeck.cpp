...
#include "SPI.h" // SD card support header
...
void setup()
{
  ...
  if (cardType == CARD_NONE) {
    Serial.print("[ERROR]: SD Card is not attached!");
    drawErrorMessage("SD Card is not attached! Make sure that the SD card is inserted correctly.");
    return;
  }
